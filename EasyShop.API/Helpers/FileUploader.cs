...
namespace EasyShop.API.Helpers
{
    public class FileUploader
    {
        public static async Task<string> Upload(IFormFile file, string webRootPath)
        {
            ...
            var path = Path.Combine(webRootPath, "Uploads/", file.FileName);
        ...
        public static async Task<ProductImage> UpdateProductImage(ProductImage productImage, IFormFile image, string webRootPath)
        {
            ...
            var path = Path.Combine(webRootPath, "Uploads/Products/", image.FileName);
        ...
        public static async Task<IEnumerable<ProductImage>> UploadProductImages(int productId, List<IFormFile> images, string webRootPath)
        {
